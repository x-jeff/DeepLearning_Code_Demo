...
print("---------------------------------------------------")
print("1.Baseline model: Emojifier-V1")
print("---------------------------------------------------")

print("---------------------------------------------------")
print("1.1.Dataset EMOJISET")
print("---------------------------------------------------")
...
print("---------------------------------------------------")
print("1.2.Overview of the Emojifier-V1")
print("---------------------------------------------------")
...
print("---------------------------------------------------")
print("1.3.Implementing Emojifier-V1")
print("---------------------------------------------------")
...
def sentence_to_avg(sentence, word_to_vec_map):
    ...
    average_word_vec = np.zeros(len(word_to_vec_map[words[0]]))

    # Step 2: average the word vectors. You can loop over the words in the list "words".
    for word in words:
        average_word_vec += word_to_vec_map[word]
    avg = average_word_vec / len(words)
...
print("---------------------------------------------------")
print("1.4.Examining test set performance")
print("---------------------------------------------------")
...
print("---------------------------------------------------")
print("2.Emojifier-V2: Using LSTMs in Keras")
print("---------------------------------------------------")
...
print("---------------------------------------------------")
print("2.1.Overview of the model")
print("---------------------------------------------------")

print("---------------------------------------------------")
print("2.2.Keras and mini-batching")
print("---------------------------------------------------")

print("---------------------------------------------------")
print("2.3.The Embedding layer")
print("---------------------------------------------------")
...
print("---------------------------------------------------")
print("2.4.Building the Emojifier-V2")
print("---------------------------------------------------")
