...
print("---------------------------------------------------")
print("1.1.Dataset and Preprocessing")
print("---------------------------------------------------")
...
print("---------------------------------------------------")
print("1.2.Overview of the model")
print("---------------------------------------------------")

print("---------------------------------------------------")
print("2.Building blocks of the model")
print("---------------------------------------------------")

print("---------------------------------------------------")
print("2.1.Clipping the gradients in the optimization loop")
print("---------------------------------------------------")
...
print("---------------------------------------------------")
print("3.Building the language model")
print("---------------------------------------------------")

print("---------------------------------------------------")
print("3.1.Gradient descent")
print("---------------------------------------------------")
