...
print("---------------------------------------------------")
print("1.2.Overview of our model")
print("---------------------------------------------------")
...
reshapor = Reshape((1, 80))  # Used in Step 2.B of djmodel(), below
...
print("---------------------------------------------------")
print("3.Generating music")
print("---------------------------------------------------")

print("---------------------------------------------------")
print("3.1.Predicting & Sampling")
print("---------------------------------------------------")
